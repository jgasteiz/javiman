"""
Django settings for javiman project.
...
WSGI_APPLICATION = 'javiman.wsgi.application'
...
CSP_IMG_SRC = ("'self'", "data:", "s.ytimg.com", "*.googleusercontent.com", "*.gstatic.com", "*.staticflickr.com", "*.s3.amazonaws.com")
